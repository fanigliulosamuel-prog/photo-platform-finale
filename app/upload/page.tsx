      ...
      <div className="flex w-full relative z-10 h-screen">
        ...
        <main className="flex-1 p-4 md:p-8 overflow-y-auto h-screen relative z-10 flex flex-col items-center justify-center">
            ...
            <div className="flex justify-between items-center mb-2">
                ...
                {/* Link dashboard rimosso qui perché c'è nel menu laterale, ma se lo vuoi come shortcut eccolo: */}
                <Link href="/dashboard" className="text-sm text-stone-200 hover:text-white transition flex items-center gap-2 px-3 py-1 rounded-full hover:bg-stone-500/20 md:hidden">
                    ← Indietro
                </Link>
            </div>
